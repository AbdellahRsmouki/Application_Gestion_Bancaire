...
public class adresseAgenceModifier extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					adresseAgenceModifier frame = new adresseAgenceModifier();
	...
	public adresseAgenceModifier() {
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setBounds(250, 340, 450, 344);
		...
		lblNewLabel.setBounds(15, 16, 316, 40);
		contentPane.add(lblNewLabel);
		
		textField = new JTextField();
		textField.setBounds(113, 67, 196, 47);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String rq1="UPDATE agence SET adresse=? where nom=?";
				...
				finally {JOptionPane.showMessageDialog(null,"Opération effectué");}
				fermer();
		...
		btnNewButton.setBounds(135, 219, 155, 40);
		contentPane.add(btnNewButton);
		
		JLabel lblSvpsaisirLeNom = new JLabel("Saisir la nouvelle adresse :");
		lblSvpsaisirLeNom.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 19));
		lblSvpsaisirLeNom.setBounds(15, 121, 344, 40);
		contentPane.add(lblSvpsaisirLeNom);
		
		textField_1 = new JTextField();
		textField_1.setColumns(10);
		textField_1.setBounds(113, 161, 196, 47);
		contentPane.add(textField_1);
		
		btnNewButton_1 = new JButton("Retour");
		btnNewButton_1.setBounds(167, 273, 89, 23);
