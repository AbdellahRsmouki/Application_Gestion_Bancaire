...
public class villeAgenceModification extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					villeAgenceModification frame = new villeAgenceModification();
	...
	public villeAgenceModification() {
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setBounds(250, 340, 450, 352);
		...
		lblNewLabel.setBounds(15, 16, 374, 40);
		contentPane.add(lblNewLabel);
		
		textField = new JTextField();
		textField.setBounds(115, 67, 196, 47);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String rq1="UPDATE agence SET ville=? where nom=?";
		...
		btnNewButton.setBounds(137, 220, 155, 40);
		contentPane.add(btnNewButton);
		
		JLabel lblSvpsaisirLeNom = new JLabel("Saisir la nouvelle ville :");
		...
		textField_1.setBounds(115, 162, 196, 47);
		...
		btnNewButton_1.setBounds(171, 279, 89, 23);
