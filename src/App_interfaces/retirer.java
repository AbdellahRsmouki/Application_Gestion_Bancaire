	...
	public retirer() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String rq2="INSERT INTO transaction VALUES ('"+DBConnection.getDate()+"','"+Client.getCIN()+"','retirer','"+Double.parseDouble(textField.getText())+"','"+compteCourant.getSolde()+"')";
